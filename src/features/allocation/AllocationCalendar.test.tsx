...
function renderCal({ onPickDay = vi.fn(), onEditAllocation = vi.fn() } = {}) {
  render(
    <AllocationCalendar
  ...
  return { onPickDay, onEditAllocation };
}
...
describe('AllocationCalendar', () => {
  ...
  it('shows every allocation as a chip with vehicle + driver (no cap, with raw-id fallbacks)', () => {
    renderCal();
